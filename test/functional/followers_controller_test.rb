...
class FollowersControllerTest < ActionController::TestCase
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post :create, follower: { avatar: @follower.avatar, entity: @follower.entity, firstName: @follower.firstName, handle: @follower.handle, lastName: @follower.lastName }
    end
  ...
  test "should update follower" do
    put :update, id: @follower, follower: { avatar: @follower.avatar, entity: @follower.entity, firstName: @follower.firstName, handle: @follower.handle, lastName: @follower.lastName }
    assert_redirected_to follower_path(assigns(:follower))
  end
